...
namespace Lion.AbpProNuget.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See AbpProNugetMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class AbpProNugetDbContext : AbpDbContext<AbpProNugetDbContext>, IAbpProNugetDbContext,
        ...
        IFileManagementDbContext
    {
         ...
         * Also map them inside AbpProNugetDbContextModelCreatingExtensions.ConfigureAbpProNuget
         */

        public AbpProNugetDbContext(DbContextOptions<AbpProNugetDbContext> options)
            : base(options)
        {
        }
